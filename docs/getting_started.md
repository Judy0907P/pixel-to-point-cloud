...
1. Navigate to the [repository](https://github.com/judy0907p/pixel-to-point-cloud).
...
1. Update the following files:
   ...
   - `README.md`:
      ...
      ```markdown
      https://judy0907p.github.io/pixel-to-point-cloud/
      ```
   ...
   - `landing.py`:
      ...
      ``` bash
      judy0907p/pixel-to-point-cloud
      ```
